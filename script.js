...
// —— 材质示例数据（完整列表） ——
const materials = [
  { name: 'Green Phantom Quartz', meaning: 'Enhances career and wealth', element: 'Wood', image: 'images/绿幽灵水晶.png'},
  { name: 'Xinjiang Old Yellow Jade', meaning: 'Brings stability and protection', element: 'Earth', image: 'images/新疆老黄玉.png' },
  { name: 'Peach Wood', meaning: 'Wards off evil spirits', element: 'Wood', image: 'images/桃木.png' },
  { name: 'Hainan Agarwood', meaning: 'Calms the mind and body', element: 'Wood', image: 'images/海南沉香.png' },
  { name: 'South African Blue Lace Agate', meaning: 'Promotes communication and clarity', element: 'Water', image: 'images/南非蓝纹玉.png' },
  { name: 'Alashan Agate', meaning: 'Enhances vitality and courage', element: 'Fire', image: 'images/阿拉善玛瑙.png' },
  { name: 'Xinjiang Hetian Jade', meaning: 'Symbolizes purity and moral integrity', element: 'Earth', image: 'images/新疆和田玉.png' },
  { name: 'Green Sandalwood', meaning: 'Brings tranquility and spiritual growth', element: 'Wood', image: 'images/绿檀木.png' },
  { name: 'Obsidian', meaning: 'Protects against negativity', element: 'Water', image: 'images/黑曜石.png' },
  { name: 'Shoushan Imperial Stone', meaning: 'Attracts wealth and prosperity', element: 'Earth', image: 'images/寿山石帝王石.png' },
